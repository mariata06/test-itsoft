...
/* harmony import */ var _modules_init_mainscreen_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-mainscreen-slider */ "./js/modules/init-mainscreen-slider.js");
/* harmony import */ var _modules_init_promo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-promo */ "./js/modules/init-promo.js");
/* harmony import */ var _modules_init_product_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-product-slider */ "./js/modules/init-product-slider.js");
/* harmony import */ var _modules_init_expert_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-expert-slider */ "./js/modules/init-expert-slider.js");
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_mainscreen_slider__WEBPACK_IMPORTED_MODULE_4__["initMainscreenSlider"])();
  Object(_modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_8__["initMobileMenu"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_promo__WEBPACK_IMPORTED_MODULE_5__["initPromo"])();
    Object(_modules_init_product_slider__WEBPACK_IMPORTED_MODULE_6__["initProductSlider"])();
    Object(_modules_init_expert_slider__WEBPACK_IMPORTED_MODULE_7__["initExpertSlider"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/init-expert-slider.js":
/*!******************************************!*\
  !*** ./js/modules/init-expert-slider.js ***!
  \******************************************/
/*! exports provided: initExpertSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initExpertSlider", function() { return initExpertSlider; });
var initExpertSlider = function initExpertSlider() {
  var expertSlider = new Swiper('.expert__slider-container', {
    loop: true,
...
/***/ "./js/modules/init-mainscreen-slider.js":
/*!**********************************************!*\
  !*** ./js/modules/init-mainscreen-slider.js ***!
  \**********************************************/
/*! exports provided: initMainscreenSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMainscreenSlider", function() { return initMainscreenSlider; });
var initMainscreenSlider = function initMainscreenSlider() {
  var mainSlider = new Swiper('.mainscreen__slider-container', {
    loop: true,
    direction: 'horizontal',
    navigation: {
...
var initMobileMenu = function initMobileMenu() {
  ...
  var iconBurger = document.querySelector('.main-nav__toggle-icon-burger');
  var iconSqueeze = document.querySelector('.main-nav__toggle-icon-squeeze');
...
var initProductSlider = function initProductSlider() {
  var productSlider = new Swiper('.product__slider-container', {
    loop: true,
    direction: 'vertical',
    navigation: {
...
var initPromo = function initPromo() {
  var el = document.querySelectorAll('.promo__desc');
